...
// Set the uniform variable of type "3x3 matrix of floats" (column-major).
void PipelineProgram::SetUniformVariableMatrix3fv(const char * name, GLboolean transpose, float value[9])
{
  glUniformMatrix4fv(GetUniformVariableHandle(name), 1, transpose, value);
}

// Set the uniform variable of type "vec3" using three float values.
void PipelineProgram::SetUniformVariable3f(const char * name, float value0, float value1, float value2)
{
  glUniform3f(GetUniformVariableHandle(name), value0, value1, value2);
}

// Set the uniform variable of type "vec3" using an array of three floats.
void PipelineProgram::SetUniformVariable3fv(const char * name, float value[3])
{
  glUniform3fv(GetUniformVariableHandle(name), 1, value);
}

// Set the uniform variable of type "vec4"
void PipelineProgram::SetUniformVariable4f(const char * name, float value0, float value1, float value2, float value3)
{
  glUniform4f(GetUniformVariableHandle(name), value0, value1, value2, value3);
}
