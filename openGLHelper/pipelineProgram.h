...
public:
  ...
  void SetUniformVariableMatrix3fv(const char * name, GLboolean transpose, float value[9]);
  // Set the uniform variable of type "vec3" using an array of three floats.
  void SetUniformVariable3fv(const char * name, float value[3]);
  // Set the uniform variable of type "vec3" using three float values.
  void SetUniformVariable3f(const char * name, float value0, float value1, float value2);
  // Set the uniform variable of type "vec4"
  void SetUniformVariable4f(const char * name, float value0, float value1, float value2, float value3);
